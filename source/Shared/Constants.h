...
#define kMTSapMachineReleasesURL        @"https://sap.github.io/SapMachine/assets/data/sapmachine_releases.json"
...
#define kMTDefaultsInstallFinished      @"InstallFinished"
#define kMTDefaultsDontRequireAdmin     @"DontRequireAdminUser"

// CFPreferences
#define kMTDaemonPreferenceDomain       CFSTR("corp.sap.SMUDaemon")
#define kMTPrefsEnableAutoUpdate        CFSTR("AutomaticUpdatesEnabled")
#define kMTPrefsLastUpdateSuccess       CFSTR("LastSuccessfulUpdate")
#define kMTPrefsLastCheckSuccess        CFSTR("LastSuccessfulCheck")
